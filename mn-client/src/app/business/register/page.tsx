...
import { Briefcase, Sparkles, Phone, MessageCircle, ArrowLeft } from "lucide-react";
      ...
      >
        <div className="flex flex-col items-center">
          ...
          <p className="text-xs text-gray-400 leading-relaxed max-w-[320px]">
            Our automated vendor portal is launching soon! You can contact our support team directly to register your business and get early partner access.
          </p>
        </div>
        ...
        <div className="space-y-3 pt-2">
          <a
            href="https://wa.me/919961341443?text=Hi%2C%20I%20want%20to%20register%20my%20wedding%20business%20on%20Malappuram%20Nikah"
            target="_blank"
