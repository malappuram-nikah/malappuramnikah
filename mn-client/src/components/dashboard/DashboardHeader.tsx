...
export default function DashboardHeader() {
  ...
  const userPhotoUrl =
    userPhotos && userPhotos.length > 0
      ? userPhotos.find((p: any) => p.isPrimary)?.dataUrl ||
  ...
  return (
    <header className="bg-white border-b border-gray-100 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between shrink-0 relative z-30">
      ...
      <div className="flex items-center gap-4 ml-4 relative" ref={dropdownRef}>
        ...
        <AnimatePresence>
          {showDropdown && <div className="hidden" />}
        </AnimatePresence>
        ...
        <div className="relative" ref={profileRef}>
          ...
          <AnimatePresence>
            {showProfileDropdown && <div className="hidden" />}
          </AnimatePresence>
        </div>
      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="grid grid-cols-2 gap-2 bg-gray-50/70 p-3 rounded-2xl border border-gray-150/80 text-[11px]">
                          ...
                          <div>
                            ...
                            <span className="font-bold text-gray-800 truncate block capitalize">
                              {user?.gender || "N/A"}
                            </span>
                          </div>
                          <div>
                        ...
                        <div className="flex items-center justify-between text-[11px] font-bold text-brand-700 bg-brand-50/30 px-3.5 py-2.5 rounded-2xl border border-brand-100/50">
                          <span className="flex items-center gap-1">
                            <Sparkles className="w-3.5 h-3.5" /> Strength:{" "}
                            {completionPercent}%
                          </span>
                        ...
                        <div className="space-y-1.5 pt-1">
                          <h3 className="text-[9px] font-bold uppercase tracking-wider text-gray-400 mb-1">
                            Actions
                          </h3>
                  ...
                  >
                    ...
                    <div className="h-28 bg-gradient-to-tr from-brand-800 to-brand-600 relative overflow-hidden shrink-0 flex flex-col justify-end p-6">
                      ...
                      <p className="text-xs text-brand-100 mt-1">
                        Stay updated with matches and messages
                      </p>
                    </div>
                      ...
                      {notifications.length === 0 ? (
                        <div className="p-8 text-center text-gray-400 h-full flex flex-col justify-center items-center">
                          ...
                          <p className="text-xs text-gray-400 mt-1">
                            Likes and message alerts will appear here.
                          </p>
                        </div>
                      ) : (
                          ...
                          return (
                            ...
                            >
                              <div className="shrink-0 relative">
                                ...
                                <span
                                  className={`absolute -bottom-1 -right-1 p-0.5 rounded-full ${iconStyle}`}
                                >
                                  {isInterest ? (
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex justify-between items-start">
                                  <p
                                    className={`text-xs font-bold text-gray-900 truncate ${isUnread ? "pr-2" : ""}`}
                                  >
                                    {notif.title}
                                  </p>
                                  {isUnread && (
