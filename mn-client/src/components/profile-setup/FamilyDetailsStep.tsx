      ...
      <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Family Type <span className="text-red-500">*</span></label>
              <select
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Financial Status <span className="text-red-500">*</span></label>
              <select
            ...
            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Family Values <span className="text-red-500">*</span></label>
